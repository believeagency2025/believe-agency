...
@section('title', 'E-commerce Solutions')
    ...
    <section class="relative pt-24 md:pt-32 pb-20 hero-bg overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6" data-aos="fade-up"
                data-i18n="service_ecom.title">{{ __('site.service_ecom.title') }}</h1>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400"
                                data-i18n="service_ecom.breadcrumb">{{ __('site.service_ecom.breadcrumb') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    <div class="mb-12" data-aos="fade-up">
                        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6"
                            data-i18n="service_ecom.heading">{{ __('site.service_ecom.heading') }}</h2>
                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-lg"
                            data-i18n="service_ecom.description">
                            {{ __('site.service_ecom.description') }}
                        </p>
                    </div>
                    ...
                    <div class="mb-16">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-8"
                            data-i18n="service_ecom.offer_title">{{ __('site.service_ecom.offer_title') }}</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2"
                                        data-i18n="service_ecom.offer1_title">{{ __('site.service_ecom.offer1_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"
                                        data-i18n="service_ecom.offer1_desc">{{ __('site.service_ecom.offer1_desc') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2"
                                        data-i18n="service_ecom.offer2_title">{{ __('site.service_ecom.offer2_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"
                                        data-i18n="service_ecom.offer2_desc">{{ __('site.service_ecom.offer2_desc') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2"
                                        data-i18n="service_ecom.offer3_title">{{ __('site.service_ecom.offer3_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"
                                        data-i18n="service_ecom.offer3_desc">{{ __('site.service_ecom.offer3_desc') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2"
                                        data-i18n="service_ecom.offer4_title">{{ __('site.service_ecom.offer4_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"
                                        data-i18n="service_ecom.offer4_desc">{{ __('site.service_ecom.offer4_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-16">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-8"
                            data-i18n="service_ecom.process_title">{{ __('site.service_ecom.process_title') }}</h3>
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                ...
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm"
                                    data-i18n="service_ecom.process1_title">{{ __('site.service_ecom.process1_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400"
                                    data-i18n="service_ecom.process1_desc">{{ __('site.service_ecom.process1_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="200">
                                <div
                                    ...
                                    2</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm"
                                    data-i18n="service_ecom.process2_title">{{ __('site.service_ecom.process2_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400"
                                    data-i18n="service_ecom.process2_desc">{{ __('site.service_ecom.process2_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="300">
                                <div
                                    ...
                                    3</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm"
                                    data-i18n="service_ecom.process3_title">{{ __('site.service_ecom.process3_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400"
                                    data-i18n="service_ecom.process3_desc">{{ __('site.service_ecom.process3_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="400">
                                <div
                                    ...
                                    4</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm"
                                    data-i18n="service_ecom.process4_title">{{ __('site.service_ecom.process4_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400"
                                    data-i18n="service_ecom.process4_desc">{{ __('site.service_ecom.process4_desc') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 space-y-8">
                    <div class="glass-card bg-brand-600 text-white p-8 rounded-3xl text-center relative overflow-hidden"
                        data-aos="fade-up">
                        <div class="absolute inset-0 bg-gradient-to-br from-brand-500 to-brand-700 opacity-90"></div>
                        <div class="relative z-10">
                            <h3 class="text-2xl font-bold mb-4" data-i18n="service_ecom.cta_title">{{ __('site.service_ecom.cta_title') }}
                            </h3>
                            <p class="text-brand-100 mb-8 text-sm" data-i18n="service_ecom.cta_desc">{{ __('site.service_ecom.cta_desc') }}</p>
                            <a href="{{ url('contact') }}"
                                ...
                                data-i18n="service_ecom.cta_btn1">
                                {{ __('site.service_ecom.cta_btn1') }}
                            </a>
                            <a href="tel:+201505194544"
                                ...
                                data-i18n="service_ecom.cta_btn2">
                                {{ __('site.service_ecom.cta_btn2') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-slate-800 p-8 rounded-3xl border border-gray-100 dark:border-white/5"
                        ...
                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-6"
                            data-i18n="service_ecom.why_title">{{ __('site.service_ecom.why_title') }}</h4>
                        <ul class="space-y-4">
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <span data-i18n="service_ecom.why1">{{ __('site.service_ecom.why1') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span data-i18n="service_ecom.why2">{{ __('site.service_ecom.why2') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span data-i18n="service_ecom.why3">{{ __('site.service_ecom.why3') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span data-i18n="service_ecom.why4">{{ __('site.service_ecom.why4') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span data-i18n="service_ecom.why5">{{ __('site.service_ecom.why5') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
