                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400"
                                >{{ __('site.service_app.breadcrumb') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mb-16">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-8">
                            {{ __('site.service_app.offer_title') }}</h3>
                            ...
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2">
                                        {{ __('site.service_app.offer1_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('site.service_app.offer1_desc') }}</p>
                                </div>
                            </div>
                            <!-- Feature 2 -->
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2">
                                        {{ __('site.service_app.offer2_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('site.service_app.offer2_desc') }}</p>
                                </div>
                            </div>
                            <!-- Feature 3 -->
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2">
                                        {{ __('site.service_app.offer3_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('site.service_app.offer3_desc') }}</p>
                                </div>
                            </div>
                            <!-- Feature 4 -->
                            <div class="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-white/5 hover:border-brand-500/30 transition-colors"
                                ...
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-red-100 dark:bg-red-500/10 flex items-center justify-center text-red-600 dark:text-red-400 text-xl">
                                        <i class="fas fa-shield-alt"></i>
                                    </div>
                                </div>
                                <div>
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2">
                                        {{ __('site.service_app.offer4_title') }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('site.service_app.offer4_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-16">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-8">
                            {{ __('site.service_app.process_title') }}</h3>
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                ...
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm">
                                    {{ __('site.service_app.process1_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    {{ __('site.service_app.process1_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="200">
                                <div
                                    ...
                                    2</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm">
                                    {{ __('site.service_app.process2_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    {{ __('site.service_app.process2_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="300">
                                <div
                                    ...
                                    3</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm">
                                    {{ __('site.service_app.process3_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    {{ __('site.service_app.process3_desc') }}</p>
                            </div>
                            <div class="text-center relative p-6 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow"
                                data-aos="fade-up" data-aos-delay="400">
                                <div
                                    ...
                                    4</div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 text-sm">
                                    {{ __('site.service_app.process4_title') }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    {{ __('site.service_app.process4_desc') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 space-y-8">
                    ...
                    <div class="bg-gray-50 dark:bg-slate-800 p-8 rounded-3xl border border-gray-100 dark:border-white/5"
                        ...
                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-6">
                            {{ __('site.service_app.why_title') }}</h4>
                        <ul class="space-y-4">
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <span>{{ __('site.service_app.why1') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span>{{ __('site.service_app.why2') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span>{{ __('site.service_app.why3') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span>{{ __('site.service_app.why4') }}</span>
                            </li>
                            <li class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                                <i class="fas fa-check-circle text-brand-500 text-lg"></i>
                                <span>{{ __('site.service_app.why5') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
