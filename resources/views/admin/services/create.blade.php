            ...
            <div class="p-8">
                ...
                <div id="content-en" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="subtitle[en]" value="{{ old('subtitle.en') }}"
                ...
                <div id="content-ar" class="space-y-6 hidden" dir="rtl">
                    ...
                    <div>
                        ...
                        <input type="text" name="subtitle[ar]" value="{{ old('subtitle.ar') }}"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="icon_class" value="{{ old('icon_class', 'fas fa-cog') }}" required
                    ...
                    @error('icon_class')
                        <p class="mt-1 text-xs text-red-500 font-bold flex items-center gap-1"><i class="fas fa-circle-exclamation"></i> {{ $message }}</p>
                    @enderror
                    <p class="text-[10px] text-slate-500 mt-2">Example: <code class="bg-slate-100 p-1 rounded">fas fa-rocket</code></p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="features" id="features_hidden" class="hidden">{{ old('features') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="process" id="process_hidden" class="hidden">{{ old('process') }}</textarea>
                </div>
