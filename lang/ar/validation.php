...
return [
    ...
    'size' => [
        ...
        'file' => 'يجب أن يكون الحقل :attribute بمقدار :size كيلوبايت.',
        'string' => 'يجب أن يكون الحقل :attribute بمقدار :size حرفًا.',
    ...
    'attributes' => [
        ...
        'role' => 'الدور',
        'role.en' => 'الدور (الإنجليزية)',
        'role.ar' => 'الدور (العربية)',
        'bio' => 'السيرة الذاتية',
        'bio.en' => 'السيرة الذاتية (الإنجليزية)',
        'bio.ar' => 'السيرة الذاتية (العربية)',
        'client_name' => 'اسم العميل',
        'client_name.en' => 'اسم العميل (الإنجليزية)',
        'client_name.ar' => 'اسم العميل (العربية)',
        'feedback' => 'التعليق',
        'feedback.en' => 'التعليق (الإنجليزية)',
        'feedback.ar' => 'التعليق (العربية)',
        'slug' => 'الرابط الفرعي',
        'icon' => 'الأيقونة',
